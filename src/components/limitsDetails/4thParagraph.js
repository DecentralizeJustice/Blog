...
Although they aren’t hack proof, they dramatically decrease the attack surface of our crypto.
...
Hardware Wallets can also be hacked if a thief has access to your physical location, but nothing short of a full time security staff can protect you from in person attacks.
...
In order to make up for some of the shortcomings of using a single hardware wallet, although their risk might be small currently, we can combine multiple wallets in a multisignature arrangement. 
</p>
`
